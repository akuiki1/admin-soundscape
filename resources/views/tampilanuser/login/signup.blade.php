            ...
            <form method="POST" action="/users">
                ...
                <div class="flex flex-col gap-2 md:flex-row">
                    <div class="mb-6 w-full md:w-1/2">
                        ...
                        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="firstname"
                            value="{{ old('firstname') }}" placeholder="masukkan nama depan"/>
                    ...
                    <div class="mb-6 w-full md:w-1/2">
                        ...
                        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="lastname"
                            value="{{ old('lastname') }}" placeholder="masukkan nama belakang"/>
                ...
                <div class="flex flex-col gap-2 md:flex-row">
                    <div class="mb-6 w-full md:w-1/2">
                        ...
                        <input type="password" class="border border-gray-200 rounded p-2 w-full" name="password" placeholder="masukkan password baru" />
                ...
                <div class="mt-8">
                    <p>
                        Sudah Memiliki Akun?
                        <a href="login-user" class="text-laravel">Login</a>
                    </p>
                    <p>
                        Anda Admin?
